...
if($_SESSION['logged_in']!=1){
	...
	if(isset($_GET['profile']) && !empty($_GET['profile'])){
        $username=mysql_real_escape_string($_GET['profile']);
            ...
            <nav>
                <ul>
                    ...
                    <ul class="drop-menu menu-5">
                        <li><a href="../Category/Portfolio.php">Portfolio</a></li>                        
          ...
          <div class="sect sectTwo"></div>
            <div id="tutoSection" class="subSection">
               <a href="#"><p>tutorials</p></a>
                <div class="tuto">
                      <a href="../news/sem.php">
                        <img src="../home/img/video.png"></a>
                      <div class="desc"><p>videos</p></div>
                    </div> 
                <div class="tuto">
                      <a href="../news/tip.php">
                        <img src="../home/img/tips.png" style="background-color:white;"></a>
                 ...
                 <a href="#"><p>news &amp; events</p></a>
                    <div class="news">
                          <a href="../news/news.php">
                            <img src="../home/img/competition.png"></a>
                          <div class="desc"><p>competition</p></div>
                    </div>
                    <div class="news">
                          <a href="../news/news.php">
                            <img src="../home/img/pprogram.png"></a>
                          <div class="desc"><p>programs</p></div>
                    </div>
                    <div class="news">
                          <a href="../news/news.php">
                            <img src="../home/img/festival.png"></a>
                          <div class="desc"><p>festivals</p></div>
                    </div>
                    <div class="news">
                          <a href="../news/news.php">
                            <img src="../home/img/exhibition.png"></a>
                          <div class="desc"><p>exhibition</p></div>
                    </div>
                    <div class="news">
                          <a href="../news/news.php">
                            <img src="../home/img/trending.png"></a>
                          <div class="desc"><p>Trending</p></div>
                    </div>
                    <div class="news">
                          <a href="../news/news.php">
                            <img src="../home/img/seo-training.png"></a>
