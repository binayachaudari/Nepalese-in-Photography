...
<div class="container">
	...
	<div class="page-header">
    	<h1 class="h2">Festivals <a class="btn btn-default" href="addnew.php?category=<?php echo $_SESSION['category']?>"> <span class="glyphicon glyphicon-plus"></span> &nbsp; Add new </a></h1> 
    </div>
    <?php } else{ ?>
		<h1 class="h2">Festivals </h1>
	<?php } ?>
<br />
...
<?php
	...
	$stmt = $DB_con->prepare('SELECT imageID, imagename, uploadedBy, userPic FROM tbl_users WHERE category="festivals" ORDER BY imageID DESC');
	$stmt->execute();
