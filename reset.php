...
<body>
    <div class="form">
          ...
          <div class="field-wrap">
            <input type="password" placeholder="New Password*" required name="newpassword" autocomplete="off"/>
            <input type="password" placeholder="Confirm New Passwrod*" required name="confirmpassword" autocomplete="off"/>
          </div>
